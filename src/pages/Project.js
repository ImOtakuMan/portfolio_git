            ...
            <div className="projects-grid">
                ...
                <img src={project1} alt="Project" className="project-img" />
                    ...
                    <div className="project-links">
                        <a href="https://github.com/twoj-login/portfolio" target="_blank">GitHub</a>
                        <a href="https://twoj-login.github.io/portfolio" target="_blank">Live</a>
                    </div>
                </div>
